...
Реализованы шаблоны страниц "Каталог", "Контакты" и "Блог"
...
Реализовано увеличение счетчика просмотров, фильтрация статей, после редактирования перенаправление на отредактированную страницу
Раелизована регистрация и авторизация пользователей
